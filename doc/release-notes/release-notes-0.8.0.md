Doriancoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/doriancoin/files/Doriancoin/doriancoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Doriancoin
...
New/changed settings (command-line or doriancoin.conf file)
--------------------------------------------------------
