Doriancoin Core version 0.14.2 is now available from:
  ...
  <https://doriancoin.org/bin/doriancoin-core-0.14.2/>
...
(in Doriancoin Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Doriancoin-Qt when using coin
...
- #10228 `ae479bc` Regenerate doriancoin-config.h as necessary (theuni)
