Download URL: https://sourceforge.net/projects/doriancoin/files/Doriancoin/doriancoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 DRC fee schedule (users still pay 0.01 DRC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #doriancoin00 - #doriancoin99
