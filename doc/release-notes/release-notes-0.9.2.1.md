Doriancoin Core version 0.9.2.1 is now available from:

  https://doriancoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 DRC to 0.01 DRC
...
- Fix "Start doriancoin on system login"
