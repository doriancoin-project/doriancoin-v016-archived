Doriancoin Core version 0.13.2 is now available from:
  ...
  <https://doriancoin.org/bin/doriancoin-core-0.13.2/>
...
- #8908 `4a974b2` Update doriancoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow doriancoin-tx to create v2 transactions (DRCdrak)
