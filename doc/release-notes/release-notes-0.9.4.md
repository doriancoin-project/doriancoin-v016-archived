Doriancoin Core version 0.9.4 is now available from:

  https://doriancoin.org/bin/0.9.4/
...
this update is incompatible with the Doriancoin system and could lead to consensus
forks.

Doriancoin Core released binaries from https://doriancoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~doriancoin/+archive/ubuntu/doriancoin
- A third-party or self-compiled Doriancoin Core

upgrade to Doriancoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
