Doriancoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/doriancoin/files/Doriancoin/doriancoin-0.5.4/
...
http://gitorious.org/doriancoin/doriancoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Doriancoin-Qt notifications under Growl 1.3.
Increase required age of Doriancoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDoriancoin properly when installing Doriancoin-Qt over it. (Windows)
