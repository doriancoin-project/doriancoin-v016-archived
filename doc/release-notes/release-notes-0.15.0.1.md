Doriancoin Core version *0.15.0.1* is now available from:

  <https://doriancoin.org/bin/doriancoin-core-0.15.0.1/>

and

  <https://doriancoincore.org/bin/doriancoin-core-0.15.0.1/>
