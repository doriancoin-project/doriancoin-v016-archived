Doriancoin Core version 0.10.4 is now available from:

  <https://doriancoin.org/bin/doriancoin-core-0.10.4/>
...
- #6953 `43c2789` Split doriancoin-tx into its own package
- #6953 `dfe0d4d` Include doriancoin-tx binary on Debian/Ubuntu
