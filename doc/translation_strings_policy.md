...
This document provides guidelines for internationalization of the Doriancoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `doriancoin_en.ts` remains unchanged.
