Doriancoin Core version 0.16.0 is now available from:
  ...
  <https://doriancoincore.org/bin/doriancoin-core-0.16.0/>
...
GUI changes
-----------
- Uses of "µDRC" in the GUI now also show the more colloquial term "bits", specified in BIP176.
...
- #11917 `bc66765` Add testnet DNS seed:  seed.testnet.doriancoin.sprovoost.nl (Sjors)
...
- #11970 `b7450cd` Add test coverage for doriancoin-cli multiwallet calls (ryanofsky)
...
- #10997 `affe927` Add option -stdinrpcpass to doriancoin-cli to allow RPC password to be read from standard input (jharvell)
...
- #12035 `eeb6d52` Change µDRC to bits (jb55)
...
- #11621 `1f7695b` [build] Add temp_doriancoin_locale_qrc to CLEAN_QT to fix make distcheck (fanquake)
...
- #11711 `6378e5c` doriancoin_qt.m4: Minor fixes and clean-ups (fanquake)
...
- #11297 `16e4184` Make sure ~/.doriancoin doesn't exist before build (MeshCollider)
...
- #11143 `3aa60b7` Fix include path for doriancoin-config.h (danra)
...
- #10871 `c9a4aa8` Handle getinfo in doriancoin-cli w/ -getinfo (revival of #8843) (achow101)
- #11419 `093074b` Utils: Fix launchctl not being able to stop doriancoind (OmeGak)
...
- #10529 `331352f` Improve doriancoind systemd service file (Flowdalic)
