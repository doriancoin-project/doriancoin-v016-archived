...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 1948
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 1949
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 11948
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 11949
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 11949
	for selinuxvariant in %{selinux_variants}; do
