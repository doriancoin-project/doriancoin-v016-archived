 ...
 * between doriancoind, and doriancoin-qt and non-server tools.
*/
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), DORIANCOIN_PID_FILENAME));
#endif
...
/** Sanity checks
 *  Ensure that Doriancoin is running in a usable environment with all
...
bool AppInitMain()
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", DORIANCOIN_CONF_FILENAME)).string());
