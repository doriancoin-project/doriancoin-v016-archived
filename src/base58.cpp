...
CTxDestination DecodeDestination(const std::string& str, const CChainParams& params)
{
    ...
    if (DecodeBase58Check(str, data)) {
        // base58-encoded Doriancoin addresses.
...
void CDoriancoinSecret::SetKey(const CKey& vchSecret)
{
...
bool CDoriancoinSecret::IsValid() const
{
...
bool CDoriancoinSecret::SetString(const char* pszSecret)
{
    return CBase58Data::SetString(pszSecret) && IsValid();
}

bool CDoriancoinSecret::SetString(const std::string& strSecret)
{
