...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<DoriancoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_doriancoin-qt -platform xcb      # Linux
//     src/qt/test/test_doriancoin-qt -platform windows  # Windows
//     src/qt/test/test_doriancoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = DoriancoinUnits::formatWithUnit(unit, balance, false, DoriancoinUnits::separatorAlways);
    ...
    // Amount input
    DoriancoinAmountField* amountInput = receiveCoinsDialog.findChild<DoriancoinAmountField*>("reqAmount");
