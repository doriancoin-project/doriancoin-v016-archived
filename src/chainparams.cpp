...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.doriancoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.doriancointools.com", true);
        vSeeds.emplace_back("dnsseed.doriancoinpool.org", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                (     0, uint256S("0xd21da25e277bd20b7456087d69c5fee2ebc6091b410271b5cb0623c7d1e7d1b9")},
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.doriancointools.com", true);
        vSeeds.emplace_back("seed-b.doriancoin.loshan.co.uk", true);
