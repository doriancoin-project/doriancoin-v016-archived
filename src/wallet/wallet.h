...
#ifndef DORIANCOIN_WALLET_WALLET_H
#define DORIANCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this doriancoin node, and set to 0 for transactions that were created
...
#endif // DORIANCOIN_WALLET_WALLET_H
