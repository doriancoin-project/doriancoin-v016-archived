...
#ifndef DORIANCOIN_TEST_SCRIPTNUM10_H
#define DORIANCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Doriancoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // DORIANCOIN_TEST_BIGNUM_H
