...
# TestNode: A peer we use to send messages to doriancoind, and store responses.
...
class CompactBlocksTest(DoriancoinTestFramework):
    ...
    # This test actually causes doriancoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that doriancoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for doriancoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # doriancoind will not send blocktxn responses for blocks whose height is
