...
This reimplements tests from the doriancoinj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure doriancoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure doriancoind isn't accepting b28
        ...
        # Doriancoin: Temporarily disable test
        ...
        #    Low-S and High-S values (whereas the doriancoin code has custom code which does so);
