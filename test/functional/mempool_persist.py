...
By default, doriancoind will dump mempool on shutdown and
...
class MempoolPersistTest(DoriancoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give doriancoind a second to reload the mempool
