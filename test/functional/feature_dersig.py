...
class BIP66Test(DoriancoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # doriancoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and doriancoind produces more specific reject
            # reasons.
